...
const FloatingDiv = () => {
  return (
    <div className="absolute z-10 -bottom-90 md:-bottom-50 mx-6 lg:px-0 lg:mx-auto  text-white md:h-60 flex flex-col md:flex-row lg:w-[85vw] xl:w-[70vw] max-w-300 left-0 right-0 rounded-lg shadow-2xl ">
      {" "}
