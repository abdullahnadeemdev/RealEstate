...
const Values = () => {
  return (
    <div className="mt-100 md:mt-75 px-6 md:px-15 xl:px-15 max-w-360 mx-auto flex flex-col-reverse md:flex-row justify-between gap-10">
      ...
      <div className="flex-1 relative p-4">
        <div
          className="flex-1 bg-light absolute top-5 left-9 
